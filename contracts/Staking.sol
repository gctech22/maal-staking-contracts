...
contract Staking {
    ...
    modifier lockEnded() {
        require(block.timestamp >= _addressToStakeTime[msg.sender] + stakeDuration, "Error: Can't unstake before lock expires");
        _;
    }
    ...
    function unstake() public onlyEOA onlyStaker lockEnded {
        _unstake();
    }
